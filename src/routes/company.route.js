...
router.patch('/:company_id/:team_id', companyTeamController.update);
...
router.patch('/:company_id/:office_id', companyOfficeController.update);
...
router.patch('/:company_id/:department_id', companyDepartmentController.update);
...
router.patch('/:company_id/:division_id', companyDivisionController.update);
...
router.patch('/:company_id/:job_title_id', companyJobTitleController.update);
...
router.patch('/:company_id/:industry_id', companyIndustryController.update);
