...
router.get('/:company_id/teams/:team_id', companyTeamController.getOne);
router.patch('/:company_id/teams/:team_id', companyTeamController.update);
router.delete('/:company_id/teams/:team_id', companyTeamController.delete);
...
router.get('/:company_id/jobs/:job_title_id', companyJobTitleController.getOne);
router.patch('/:company_id/jobs/:job_title_id', companyJobTitleController.update);
router.delete('/:company_id/jobs/:job_title_id', companyJobTitleController.delete);
